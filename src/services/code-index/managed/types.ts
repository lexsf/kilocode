...
/**
 * Client-side cache structure for managed indexing
 */
export interface ClientCache {
	/** Current git branch */
	gitBranch: string
	/** Files deleted on this branch (vs base branch) */
	deletedFiles: string[]
	/** Indexed files with their metadata */
	files: Record<
		string,
		{
			...
			lastIndexed: number
			/** Number of chunks generated for this file */
			chunkCount: number
		}
	>
}
